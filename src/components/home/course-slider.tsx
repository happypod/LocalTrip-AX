...
export function CourseSlider({ items }: { items: HomeItem[] }) {
  ...
  useEffect(() => {
    ...
    if (container) {
      ...
      // Prevent native browser drag-and-drop ghost image behavior
  ...
  return (
    <div className="relative group/slider w-full">
      {/* Dynamic Style block to completely hide the scrollbar cross-browser */}
