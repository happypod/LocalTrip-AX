...
- **콘텐츠**:
  - 숙소: 이미지 보유/미보유, 다양한 CTA(전화/카카오/네이버) 조합의 3개 데이터
  - 체험: 실제 서핑, 공예 등 실용적 설명이 포함된 3개 데이터
  - 주민소득상품: 생활서비스 연계 및 수익 환원 계획이 포함된 특화 데이터 3개
- **추천 코스**: 숙소-체험-주민상품을 잇는 2개 코스 (XOR 관계 준수)
- **전환 트래킹**: 월간 통계 테스트를 위한 `LeadEvent` 샘플 5개 포함
